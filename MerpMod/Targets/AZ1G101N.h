#define MOD_IDENTIFIER STRI(AZ1G101N.MeRpMoD.Switch.Testing.v00.60.d16.5.17.1200)
#define MOD_ECUID 923A006023
#define MOD_DATE 16.5.17.1200
#include "Switch.h"
